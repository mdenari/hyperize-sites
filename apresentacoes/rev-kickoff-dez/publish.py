...
# ... inside main() ...
    ...
    try:
        # Ignore .git folder to prevent permission issues and bloat
        shutil.copytree(args.source, target_dir, ignore=shutil.ignore_patterns('.git', '.github', '__pycache__', 'node_modules'))
